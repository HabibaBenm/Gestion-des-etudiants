...
<%@page import="Method.EtudiantMeth"%>
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/GestionEtudiants/assets/vendors/select2/select2.min.css">
    <link rel="stylesheet" href="http://localhost:8080/GestionEtudiants/assets/vendors/select2-bootstrap-theme/select2-bootstrap.min.css">
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="home.jsp"><img src="http://localhost:8080/GestionEtudiants/assets/images/new_logo copie.png" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="home.jsp"><img src="http://localhost:8080/GestionEtudiants/assets/images/icon.png" alt="logo" /></a>
        </div>
        <ul class="nav">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="http://localhost:8080/GestionEtudiants/img-xs rounded-circle" src="http://localhost:8080/GestionEtudiants/assets/images/icon.png" alt="">
              ...
              <div class="col-8 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="ajout" method="post" class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="prenom" id="exampleInputUsername1" placeholder="Prenom" value="${ prenom }">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="TypeBac"id="exampleInputCity1" placeholder="Type de baccalaureat" value="${ TypeBac }">
