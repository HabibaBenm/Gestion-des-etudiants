    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="http://localhost:8080/GestionEtudiants/ajout.jsp">
              <span class="menu-icon">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="http://localhost:8080/GestionEtudiants/home.jsp"><img src="http://localhost:8080/AppEtudiant/assets/images/logo-mini.svg" alt="logo" /></a>
          </div>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-8 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Supprimer un etudiant</h4>
