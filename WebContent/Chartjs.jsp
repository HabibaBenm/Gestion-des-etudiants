    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="http://localhost:8080/GestionEtudiants/home.jsp"><img src="http://localhost:8080/GestionEtudiants/assets/images/new_logo.png" alt="logo" /></a>
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="http://localhost:8080/GestionEtudiants/assets/images/faces-clipartâ©/pic-8.png" alt="">
